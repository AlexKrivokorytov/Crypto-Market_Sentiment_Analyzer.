...
export const authApi = {
    ...
    updateWatchlist(assetId, action) {
        return authFetch(`${BASE_URL}/watchlist`, {
            method: 'PUT',
...
export const portfolioApi = {
     ...
     */
    getPortfolio() {
        return authFetch(`${BASE_URL}/portfolio`);
    },
    /**
    ...
    deletePosition(assetId) {
        return authFetch(`${BASE_URL}/portfolio/${assetId}`, { method: 'DELETE' });
    },
    /**
     ...
     */
    getAlerts() {
        return authFetch(`${BASE_URL}/alerts`);
    },
    /**
     ...
     */
    deleteAlert(alertId) {
        return authFetch(`${BASE_URL}/alerts/${alertId}`, { method: 'DELETE' });
    },
};
